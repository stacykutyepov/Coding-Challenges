...
// ^(1\s?)? - matches first character ^ to be 1 with an optional ? space \s and the whole first expression is optional ?;
// (\(\d{3}\)|\d{3}) - match digits, they should be {3} with or without ();
// [\s\-]? - matches space or a dash, and ? means it's optional
